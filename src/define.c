...
//Funkcja dodaje do danej definicji jej rozwiniecie, oraz zapisuje w jaki konkretnie sposob ma podstwiac zmienne
...
//Funkcja dodaje do definicji nowe wyst¹pienie danej zmiennej
bool add_variable_occur_to_list(_define *element, int *variables_max, int i, int position)
{
